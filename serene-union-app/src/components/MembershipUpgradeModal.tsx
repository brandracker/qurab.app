  ...
  const products = [
    {
      ...
      tag: 'Most Popular',
      price: '$9.99 / mo',
      localPrice: 'PKR 1,999 / month',
      description: 'Unlimited likes, See Who Liked You, 100% Ad-Free, 5 Direct Salams/mo & Priority ranking.',
      icon: 'workspace_premium',
      isSubscription: true
    },
    {
      id: 'serene_direct_salam_5',
      title: '5 Direct Salams Pack',
      tag: 'Fast Intro',
      price: '$1.99',
      localPrice: 'PKR 499 (5 Passes)',
      description: 'Send direct messages directly to candidates’ inbox without waiting for mutual match.',
    ...
    },
    {
      ...
      tag: '10x Views',
      price: '$2.99',
      localPrice: 'PKR 699 (24 Hours)',
      description: 'Feature your profile at the #1 top spot in your city’s Discover feed.',
      icon: 'bolt',
      isSubscription: false
    },
    {
              ...
              <div className="flex items-center justify-between pb-3 border-b border-surface-variant/40">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-secondary">Serene Union Matrimonial</p>
                  </div>
                </div>
